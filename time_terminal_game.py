...
class TimeTerminalApp:
    ...
    def _cmd_help(self):
        ...
        self.print_line("  date                     - show current system date")
        self.print_line("  time                     - show current system time")
        self.print_line("  datetime                 - show current system date and time")

    def _cmd_date(self):
        now = time.localtime()
        self.print_line(time.strftime("[SYS] Date: %Y-%m-%d", now))

    def _cmd_time(self):
        now = time.localtime()
        self.print_line(time.strftime("[SYS] Time: %H:%M:%S", now))

    def _cmd_datetime(self):
        now = time.localtime()
        self.print_line(time.strftime("[SYS] DateTime: %Y-%m-%d %H:%M:%S", now))
